...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
    ...
    static TCHAR szWindowCaption[] = TEXT("Hello Window...");
    ...
    if(hIcon == NULL)
    {
        MessageBox((HWND)NULL, TEXT("Colud Not Obtain Icon"), TEXT("LoadIcon"), MB_ICONERROR);
        return (EXIT_FAILURE);       
    }
    ...
    {
        MessageBox((HWND)NULL, TEXT("Could Not Regiaster Window Class"), TEXT("RegisterClassEx"), MB_ICONERROR);
        return (EXIT_FAILURE);
    }
    ...
    if(hWnd == NULL)
    {
        MessageBox((HWND)NULL, TEXT("Colud Not Create Application Window"), TEXT("CreateWindowEx"), MB_ICONERROR);
        return (EXIT_FAILURE);
    }
